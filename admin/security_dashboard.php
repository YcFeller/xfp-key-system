    ...
    <div class="container">
        ...
        <div class="tabs">
            <div class="tab-buttons">
                ...
                <button class="tab-button" onclick="switchTab('management')">系统管理</button>
            </div>
            ...
            <div class="tab-content">
                ...
                <div id="blacklist" class="tab-pane">
                    <div style="margin-bottom: 1rem;">
                        <button class="btn btn-primary" onclick="showBanForm()">添加IP封禁</button>
                    </div>
                        ...
                        html += `
                            <div class="blacklist-item">
                                <div class="blacklist-info">
                                    ...
                                    <div class="blacklist-reason">${item.reason || '无原因'}</div>
                                    <div class="blacklist-time">
                                        封禁时间: ${item.created_at}
                                        ${item.banned_until ? `到期时间: ${item.banned_until}` : '永久封禁'}
                                    </div>
                                </div>
                                <div>
                                    ${isActive ? 
                                        `<button class="btn btn-success" onclick="unbanIp('${item.ip}')">解封</button>` :
